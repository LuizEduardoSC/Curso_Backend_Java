...
public class VendaController implements Serializable {
	...
	public void onRowEdit(RowEditEvent event) {
	    // Você precisará fazer o cast manualmente para obter o objeto
	    ProdutoQuantidade prod = (ProdutoQuantidade) event.getObject();
	    adicionarOuRemoverProduto(prod);
	}

	public void onRowCancel(RowEditEvent event) {
	    // Removemos o <ProdutoQuantidade> da assinatura do método
	    // O cast para obter o objeto continua funcionando normalmente
	    FacesMessage msg = new FacesMessage("Edit Cancelled", String.valueOf(((ProdutoQuantidade)event.getObject()).getId()));
